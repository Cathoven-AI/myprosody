...
# After intensity calculations and threshold determination

# After silence/sounding analysis
...
if int<2
	appendInfoLine: 0,tab$,0,tab$,0,tab$,0,tab$,0,tab$,0,tab$,0,tab$,0,tab$,0,tab$,0,tab$,0,tab$,0,tab$,0,tab$,0,tab$,0,tab$,0,tab$,0,tab$,0,tab$,0,tab$,0,tab$,0,tab$,0,tab$,0,tab$,0,tab$,0, tab$,0
endif